(ns marketentry.store
  "SSoT for the Nauru (NRU) market-entry compliance actor, behind a
  ...
  `:split-group` links two or more engagements together for the
  flagship `artificial-division-violation?` cross-entity check
  (`marketentry.registry`) -- `all-engagements` is how the governor
  gathers the rest of a declared split-group's own members.
...
(defn demo-data
  ...
  `:contract-value` / `:foreign-or-international-funded?` /
  `:conducted-via-procurement-agent?` / `:procurement-agent` /
  `:split-group` are ground truth for the `procurement-agent-
  requirement-mismatch?` / `artificial-division-violation?` flagship
  checks (Public Finance (Control and Management) Regulations 2013 reg
  6(1)/(3); Act 1997 s.15E(4)); `:requires-tin-verification?` /
  `:tin-verified?` are ground truth for the conditional Tax
  Identification Number verification check (Employment and Services
  Tax Act; Revenue Administration Act, Nauru Revenue Office)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Yaren Fisheries Cooperative" :portal "naurufinance.info/treasury-division/procurement"
             ...
             :split-group nil
             :requires-tin-verification? true :tin-verified? true
             :drafted? false :submitted? false
             :jurisdiction "NRU" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "naurufinance.info/treasury-division/procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value 2000.0 :foreign-or-international-funded? false
             :conducted-via-procurement-agent? false :procurement-agent nil
    ...
    "eng-3" {:id "eng-3" :operator "Denig Trading Co" :portal "naurufinance.info/treasury-division/procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "NRU" :status :intake}
    "eng-4" {:id "eng-4" :operator "Aiwo Import Export Ltd" :portal "naurufinance.info/treasury-division/procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "NRU" :status :intake}
    "eng-5" {:id "eng-5" :operator "Boe Logistics Partners" :portal "naurufinance.info/treasury-division/procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value 2000.0 :foreign-or-international-funded? false
             :conducted-via-procurement-agent? false :procurement-agent nil
             :split-group nil
             :requires-tin-verification? true :tin-verified? false
             :drafted? false :submitted? false
             :jurisdiction "NRU" :status :intake}
    "eng-6" {:id "eng-6" :operator "Anibare Construction Supplies" :portal "naurufinance.info/treasury-division/procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value 2000.0 :foreign-or-international-funded? false
             :conducted-via-procurement-agent? false :procurement-agent nil
             ...
             :drafted? false :submitted? false
             :jurisdiction "NRU" :status :intake}
    "eng-7" {:id "eng-7" :operator "Anibare Construction Materials" :portal "naurufinance.info/treasury-division/procurement"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contract-value 1500.0 :foreign-or-international-funded? false
             :conducted-via-procurement-agent? false :procurement-agent nil
             :split-group "grp-1"
             :requires-tin-verification? true :tin-verified? true
             :drafted? false :submitted? false
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               ...
                               conducted-via-procurement-agent? procurement-agent
                               split-group
                               requires-tin-verification? tin-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? foreign-or-international-funded?)   (assoc :engagement/foreign-or-international-funded? foreign-or-international-funded?)
    (some? conducted-via-procurement-agent?)   (assoc :engagement/conducted-via-procurement-agent? conducted-via-procurement-agent?)
    (some? procurement-agent)                  (assoc :engagement/procurement-agent (enc procurement-agent))
    (some? split-group)                        (assoc :engagement/split-group split-group)
    (some? requires-tin-verification?)         (assoc :engagement/requires-tin-verification? requires-tin-verification?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/contract-value :engagement/foreign-or-international-funded?
   :engagement/conducted-via-procurement-agent? :engagement/procurement-agent
   :engagement/split-group
   :engagement/requires-tin-verification? :engagement/tin-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :foreign-or-international-funded? (boolean (:engagement/foreign-or-international-funded? m))
     :conducted-via-procurement-agent? (boolean (:engagement/conducted-via-procurement-agent? m))
     :procurement-agent (dec* (:engagement/procurement-agent m))
     :split-group (:engagement/split-group m)
     :requires-tin-verification? (boolean (:engagement/requires-tin-verification? m))
